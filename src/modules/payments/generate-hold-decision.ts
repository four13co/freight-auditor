 ...
 * unique constraint on Development yet (0048's constraint is unmerged, see
 * #163/#164's same reasoning for not referencing it by name), so this is a
 * plain SELECT-then-INSERT inside the caller's transaction.
 */
