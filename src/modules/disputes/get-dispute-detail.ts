 ...
 * tenant -- the caller maps that to 404, matching create-dispute-from-
 * findings.ts's convention for the same "doesn't exist" vs "not yours"
 * ambiguity.
 *
 ...
 * (citations) come from other unmerged work. Lines + amounts + currency is
 * the reviewable surface for this item; prose narration is a later
 * additive slice, not a dependency of this one.
 */
