...
// NOT RUNNABLE until #183 (workflow_instance, migration 0046) merges to
// Development -- this file seeds workflow_instance directly, which does not
// exist on the base this PR branches from. Mirrors #169's identical
// disclosure for workflow_transition. Unit tests in
// test/unit/schedule-workflow-command.test.ts and
// test/unit/claim-due-workflow-commands.test.ts are this round's real proof.
