 ...
 * tenant-scoped transaction (withTenantTx) so RLS restricts account_id to
...
export async function upsertPaymentPolicy(
  ...
  await client.query(
    `INSERT INTO account_payment_policy
       (account_id, hold_then_approve, short_pay_enabled, approval_expiry_hours, configured_by)
     VALUES ($1,$2,$3,$4,$5)
