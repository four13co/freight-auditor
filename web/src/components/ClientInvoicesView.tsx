...
export function ClientInvoicesView() {
  ...
  return (
    <section data-testid="client-invoices-view" className="border border-[rgba(32,30,29,.3)] bg-[#f3f2f2] p-3">
      ...
      {error && (
        <span data-testid="client-invoices-error" className="text-xs font-semibold text-[#7c1405]">
      ...
      {!error && invoices !== null && invoices.length === 0 && (
        <span data-testid="client-invoices-empty" className="text-xs font-semibold text-[rgba(32,30,29,0.65)]">
